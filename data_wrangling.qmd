...
df_clean <- df_clean |> 
  select(
    ...
    mother_functional_disability_18_49,
    ethnicity,
...
```{r}
# Filter Don't knows from dataset
fct_drop(c(df_clean$child_had_diarrhoea_last_two_weeks, df_clean$child_ill_cough_two_weeks, df_clean$child_ill_fever_two_weeks), only = "Dk")
```
